...
def mostrandoDistancias():
  ...
  if(usuarios < usuarios2):
    ...
    elementos.append(opc1) #la opcion que eligió el usuario 1
    elementos.append(posicion)#la posición en el arreglo zonasWifi  2
    elementos.append(posicion2)#la posición en el arreglo zonasWifi 3
    elementos.append(menor)#El numero de usuarios 4
    elementos.append(menor2)#El numero de usuarios 5
    indicacionesLlegada()
  else:
    print("Zonas wifi cercanas con menos usuarios") 
